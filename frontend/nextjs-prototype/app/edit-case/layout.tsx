...
export default function EditCaseLayout({
  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-6 bg-background text-foreground transition-none">
      {/* Header – erscheint nur hier */}
      <header className="flex w-full max-w-6xl justify-between items-center py-6 bg-gray-100 dark:bg-header-background px-4 rounded-lg shadow-md gap-6">
      ...
      {/* Hauptinhalt */}
      <div className="w-full max-w-6xl mt-10">{children}</div>
    </main>
  );
}
